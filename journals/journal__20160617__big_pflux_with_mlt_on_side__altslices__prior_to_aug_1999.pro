...
PRO JOURNAL__20160617__BIG_PFLUX_WITH_MLT_ON_SIDE__ALTSLICES__PRIOR_TO_AUG_1999
  ...
  ;; restrict_poyntRange  = [0.05,100000] ;;Before I realized that Poynting flux wasn't actually fixed, around 05/04 or something
  restrict_poyntRange  = [5.0,100000]
  ...
  ;;************************************************************
  ;;to be outputted
  savePlotPref      = '20160617--pflux_GE_'+ STRING(FORMAT='(G0.2)',restrict_poyntRange[0])
