;;2017/01/02
;;Need ephem for missing katusness
PRO JOURNAL__20171201__FASTLOC7__MISSING_KATUS

  COMPILE_OPT IDL2,STRICTARRSUBS

  PRINT,"HAVE DONE ZERO WORK ON THIS; JUST A RIPOFF OF A 20170102 (FASTLOC6) JOURNAL AT THIS POINT)"
  STOP
