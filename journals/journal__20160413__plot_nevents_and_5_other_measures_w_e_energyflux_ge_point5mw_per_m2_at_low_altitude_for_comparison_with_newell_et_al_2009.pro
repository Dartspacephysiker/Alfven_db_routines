...
PRO JOURNAL__20160413__PLOT_NEVENTS_AND_5_OTHER_MEASURES_W_E_ENERGYFLUX_GE_POINT5MW_PER_M2_AT_LOW_ALTITUDE_FOR_COMPARISON_WITH_NEWELL_ET_AL_2009
  ...
  nPlots                   = 1
  nEventsPlotRange         = [0,3750]
  nEventsPlotNormalize     = 0  

  nOrbsWithEventsPerContribOrbsPlot = 1
  nowepco_range            = [0,0.50]

  orbContribPlot           = 1
  orbContribRange          = [20,220]
  orbContrib_noMask        = 1

  tHistDenominatorPlot     = 1
  tHistDenomPlotRange      = [0,140]
  ...
  restrict_with_these_i          = WHERE(maximus.elec_energy_flux GE eFluxMin)

  FOR i=0,N_ELEMENTS(altRange[0,*])-1 DO BEGIN
     altitudeRange = altRange[*,i]
     altStr        = STRING(FORMAT='("--",I0,"-",I0,"km")',altitudeRange[0],altitudeRange[1]) + '--maxeFlux_GE_'+STRCOMPRESS(eFluxMin,/REMOVE_ALL)
