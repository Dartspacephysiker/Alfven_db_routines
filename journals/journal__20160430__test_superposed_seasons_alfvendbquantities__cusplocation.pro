PRO JOURNAL__20160430__TEST_SUPERPOSED_SEASONS_ALFVENDBQUANTITIES__CUSPLOCATION
  ...
  ;;OMNI quants?
  OMNI_quantities_to_plot = ['cusploc_n_gsm__x']
  ...
  probOccPref       = pref + '--' + STRUPCASE(OMNI_quantities_to_plot) + $
