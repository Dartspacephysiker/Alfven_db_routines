...
PRO JOURNAL__20160428__HISTOPLOT_OF_WIDTH_TIME_AND_WIDTH_X_FOR_EVENTS_AT_AND_AROUND_CUSP
  ...
  ;; precusp_i                      = CGSETINTERSECTION(restrict_with_these_i, $
  ;;                                                    WHERE(maximus.mlt GE minMArr[1] AND maximus.mlt LE maxMArr[1]))
  ;; postcusp_i                     = CGSETINTERSECTION(restrict_with_these_i, $
  ...
  precusp_i                      = WHERE(maximus.mlt GE minMArr[1] AND maximus.mlt LE maxMArr[1])
  postcusp_i                     = WHERE(maximus.mlt GE minMArr[2] AND maximus.mlt LE maxMArr[2])
  
  indices_list                   = LIST(cusp_i,precusp_i,postcusp_i)
  ;; names_for_sets_of_inds         = ['Dayside','Nightside']
  ;; fancyNames_for_sets_of_inds    = ['Dayside','Nightside']
  names_for_sets_of_inds         = ['Cusp','pre-cusp','post-cusp']
  fancyNames_for_sets_of_inds    = ['Cusp','Pre-cusp (9-11 MLT)','Post-cusp (13-15 MLT)']
  ...
  FOR i=0,N_ELEMENTS(altRange[0,*])-1 DO BEGIN
     ...
     altStr        = STRING(FORMAT='("--",I0,"-",I0,"km")',altitudeRange[0],altitudeRange[1])+'--cusp_precusp_postcusp'
