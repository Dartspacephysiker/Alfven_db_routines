PRO JOURNAL__20160503__CRAZY_NIGHTSIDE_DIST_OF_PFLUX__SEPARATE_INTO_QUARTERS__HIGHER_ALTS
  ...
  CGHISTOPLOT,ALOG10(maximus.pfluxest[premidnight_i]), $
              ...
              OUTPUT=plotDir+'pFlux_dist_premidnight--'+filePremidnightMLT+altString+'.png', $
              MAXINPUT=plotMax, $
              MININPUT=plotMin, $
              BINSIZE=binsize
  ...
  CGHISTOPLOT,ALOG10(maximus.pfluxest[postmidnight_i]), $
              ...
              OUTPUT=plotDir+'pFlux_dist_postmidnight--'+filePostmidnightMLT+altString+'.png', $
              MAXINPUT=plotMax, $
              MININPUT=plotMin, $
              BINSIZE=binsize
