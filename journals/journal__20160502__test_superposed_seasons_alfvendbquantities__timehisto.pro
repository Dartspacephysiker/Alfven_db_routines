PRO JOURNAL__20160502__TEST_SUPERPOSED_SEASONS_ALFVENDBQUANTITIES__TIMEHISTO
  ...
  ;;OMNI quants?
  ;; OMNI_quantities_to_plot = ['Dst','SSN']
  ;; OMNI_quantity_ranges    = [[-250,50], $
  ;;                            [0,250]]
  OMNI_quantities_to_plot = 'Dst'
  OMNI_quantity_ranges    = [-250,50]
                            
  only_OMNI_plots         = 0

  ;;which plot type?
  probOccurrence_sea    = 0
  tHist_sea             = 1
  tHist_autoscale       = 1
  ;; histoRange = [0,0.05]
