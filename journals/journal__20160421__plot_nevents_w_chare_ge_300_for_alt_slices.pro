...
PRO JOURNAL__20160421__PLOT_NEVENTS_W_CHARE_GE_300_FOR_ALT_SLICES

  hemi                     = 'NORTH'
  ;; hemi                     = 'SOUTH'
  
  charERange               = [300,30000]
  ...
  n_tile_columns           = 3
  n_tile_rows              = 1
  tilePlotSuff             = "--normed_nEvents_tHistos__and_log_nEvPerMin"
  ...
  FOR i=0,N_ELEMENTS(altRange[0,*])-1 DO BEGIN
     ...
     altStr        = STRING(FORMAT='("--",I0,"-",I0,"km")',altitudeRange[0],altitudeRange[1])+'--charERange_'+STRCOMPRESS(charERange[0],/REMOVE_ALL)+'-'+STRCOMPRESS(charERange[1],/REMOVE_ALL)+'eV'
