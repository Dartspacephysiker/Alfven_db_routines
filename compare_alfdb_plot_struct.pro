...
PRO COMPARE_ALFDB_PLOT_STRUCT,alfDB_plot_struct1, $
  ...
  FOR k=0,N_ELEMENTS(comp)-1 DO BEGIN
     ...
     IF tmpComp.nDiff GT 0 THEN BEGIN
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*overplot_file*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*op_plotRange*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*custom_integral*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*nCustomIntegrals*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*SWAY_PLOTTYPE*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*CALCVAR_EFLUX*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*CALCVAR_IFLUX*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*CALCVAR_MAGC*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
        ...
        IF STRMATCH(tmpComp.field,STRUPCASE('*VAR__EACH_BIN*')) THEN BEGIN
           ;; DBs_reset      += 0B
           ;; inds_reset     += 0B
           dontstop        = 1
           matchArr        = [matchArr,tmpComp.field]
