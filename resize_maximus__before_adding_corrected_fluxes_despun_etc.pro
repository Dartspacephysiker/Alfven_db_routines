...
FUNCTION RESIZE_MAXIMUS__BEFORE_ADDING_CORRECTED_FLUXES_DESPUN_ETC,maximus,MAXIMUS_IND=maximus_ind,MIN_FOR_IND=min_for_ind,MAX_FOR_IND=max_for_ind,ONLY_ABSVALS=only_absVals,INDS=inds,CDBTIME=cdbTime
