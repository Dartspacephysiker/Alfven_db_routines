;Monday, Dec 15, 2014 (San Fran, AGU!): New routine: rdf_stats_Dartmouth_as5_startstop_inc.
;Adding start/stop times of current intervals so that we can see exactly what the overlap is
;between Chaston and Dartmouth events
;example: 
;datdir /SPENCEdata2/software/sdt/batch_jobs/Alfven_study/as5_14F/batch_output/Dartmouth_as5_startstop_dflux_blah_0
...
pro rdf_stats_dartmouth_as5_startstop_inc,filename,dat,outname
