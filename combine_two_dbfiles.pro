pro combine_two_dbfiles,maximus,cdbTime,DBFILE1=dbFile1,DB_TFILE1=db_tFile1,DBFILE2=dbFile2,DB_TFILE2=db_tFile2, $
  ...
  IF KEYWORD_SET(save_combined_file) THEN BEGIN
     ...
     IF ~KEYWORD_SET(outFile) THEN outFile=outDir+'Dartdb_' + date + '--500-16361_inc_lower_lats--maximus.sav'
     IF ~KEYWORD_SET(out_tFile) THEN out_tFile=outDir+'Dartdb_' + date + '--500-16361_inc_lower_lats--cdbtime.sav'
  ENDIF
