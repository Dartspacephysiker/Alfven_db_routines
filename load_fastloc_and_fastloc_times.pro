...
PRO LOAD_FASTLOC_AND_FASTLOC_TIMES,fastLoc,fastloc_times,fastloc_delta_t, $
  ...
  ;; DefDBDir = '/SPENCEdata/Research/database/FAST_ephemeris/fastLoc_intervals2/'
  ...
  ;; DefDBDir = '/SPENCEdata/Research/database/FAST_ephemeris/fastLoc_intervals3/'
  ...
  DefDBDir = '/SPENCEdata/Research/database/FAST_ephemeris/fastLoc_intervals4/'
